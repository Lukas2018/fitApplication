    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_days', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.day')),
                ('dishes', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.dish')),
                ('trainings', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.training')),
